...
Dieses Repository enthält den ersten interaktiven Frontend-Prototypen, der das Kernkonzept demonstriert:
...
- Integriertes Design-System (Dark-Theme mit Akzentfarben).
